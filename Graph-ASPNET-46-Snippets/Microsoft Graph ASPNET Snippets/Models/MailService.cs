...
namespace Microsoft_Graph_ASPNET_Snippets.Models
{
    public class MailService
    {
        ...
        public async Task<List<ResultsItem>> GetMyInboxMessages()
        {
            List<ResultsItem> items = new List<ResultsItem>();
            
            // Get messages in the Inbox folder.
            IMailFolderMessagesCollectionPage messages = await graphClient.Me.MailFolders.Inbox.Messages.Request(requestOptions)
        ...
        public async Task<List<ResultsItem>> GetMyInboxMessagesThatHaveAttachments()
        {
            List<ResultsItem> items = new List<ResultsItem>();
        ...
        public async Task<List<ResultsItem>> SendMessage()
        {
            List<ResultsItem> items = new List<ResultsItem>();
            
            // Create the recipient list. This snippet uses the current user as the recipient.
            User me = await graphClient.Me.Request(requestOptions).WithUserAccount(ClaimsPrincipal.Current.ToGraphUserAccount()).Select("Mail, UserPrincipalName").GetAsync();
            ...
            // Send the message.
            await graphClient.Me.SendMail(email, true).Request(requestOptions).WithUserAccount(ClaimsPrincipal.Current.ToGraphUserAccount()).PostAsync();
        ...
        // This snippet sends a message to the current user on behalf of the current user.
        public async Task<List<ResultsItem>> SendMessageWithAttachment()
        {
            List<ResultsItem> items = new List<ResultsItem>();
        ...
        public async Task<List<ResultsItem>> GetMessage(string id)
        {
            List<ResultsItem> items = new List<ResultsItem>();
        ...
        public async Task<List<ResultsItem>> ReplyToMessage(string id)
        {
            List<ResultsItem> items = new List<ResultsItem>();
        ...
        public async Task<List<ResultsItem>> MoveMessage(string id)
        {
            List<ResultsItem> items = new List<ResultsItem>();

            // Move the message.
            Message message = await graphClient.Me.Messages[id].Move("Drafts").Request(requestOptions).WithUserAccount(ClaimsPrincipal.Current.ToGraphUserAccount()).PostAsync();
        ...
        public async Task<List<ResultsItem>> DeleteMessage(string id)
        {
            List<ResultsItem> items = new List<ResultsItem>();
            
            // Delete the message.
            await graphClient.Me.Messages[id].Request(requestOptions).WithUserAccount(ClaimsPrincipal.Current.ToGraphUserAccount()).DeleteAsync();
